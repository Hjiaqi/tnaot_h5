<template>
    <div class="recContainer" v-infinite-scroll="loadBottomAjax" infinite-scroll-disabled="bottomLock" infinite-scroll-distance="10" infinite-scroll-immediate-check="false" >
            ...
            <ul class="live-shop-list">
                <li>
                    ...
                    <div class="information-header clearfix">
                        ...
                        <span class="recruit-infor fl-right">招聘 职位</span>
                    </div>
                    <router-link to="/recruitDetail/1">
                        <h2 class="information-in">发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息</h2>
                    </router-link>
                    <!--归类 -->
                    <div class="list-tail">
                        <span class="classified">招聘</span>
                ...
                <li>
                    ...
                    <router-link to="/recruitDetail/2">
                        <h2 class="information-in">发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息</h2>
                    </router-link>
                    <!--归类 -->
                    <div class="list-tail">
                ...
                <li>
                    ...
                    <router-link to="/recruitDetail/3">
                        <h2 class="information-in">发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息发布的相关信息</h2>
                    </router-link>
                    <!--归类 -->
                    <div class="list-tail">
...
export default {
    ...
    methods:{
        ...
        handleLocaltion(type) {
            if (type === 'get') {
                this.$nextTick(() => {
                    document.querySelector(".recContainer").scrollTop = sessionStorage.getItem('recScrollTop');
               })
            } else if ( type === 'set' ) {
	            let scrollTop = document.querySelector(".recContainer").scrollTop;
				sessionStorage.setItem('recScrollTop', scrollTop);
	        }
        },
        saveScroll() {
