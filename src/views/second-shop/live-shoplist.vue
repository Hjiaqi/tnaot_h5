...
export default {
    ...
    methods:{
        ...
        handleLocaltion(type) {
            if (type === 'get') {
                this.$nextTick(() => {
                    document.querySelector(".container").scrollTop = sessionStorage.getItem('shoScrollTop');
               })
            } else if ( type === 'set' ) {
	            let scrollTop = document.querySelector(".container").scrollTop;
				sessionStorage.setItem('shoScrollTop', scrollTop);
	        }
        },
        saveScroll() {
